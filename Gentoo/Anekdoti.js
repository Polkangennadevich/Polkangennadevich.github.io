function mail() {
    ...
    var iCurInk = 0;
    var sCurCaret = '';
    var sCaret = "&nbsp;<img src='Gentoo/pen.gif' style='position:absolute'>";
    ...
    var doStep = function () {
        ...
        if (sChar == ' ') {
            iCurInk += iSpeedInk;
            sChar = '</span><span style="color:rgb(1, 71, 255)">' + sChar;// '</span><span style="color:rgb(' + (iCurInk) + ',' + (iCurInk) + ',' + (iCurInk) + ')">' + sChar;
        }

        if (document.getElementById('inkwell2').style.visibility == 'visible') {
            sCurCaret = sCaret;
            document.getElementById('inkwell2').style.visibility = 'hidden';
            sChar = '</span><span style="color:rgb(1, 71, 255)">' + sChar;
        }
